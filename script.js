...
// task 8: prime number factorization
console.log("");
console.log("task 8:");
...
console.log("");
console.log("task 10");
console.log(`does this array contain ${v}?
it is ${containsValue(a, v)}.`);

// part 2: medium to hard
console.log("");
console.log("part 2: medium to hard");
